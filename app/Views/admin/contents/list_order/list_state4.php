<div class="card">
    ...
    <div class="card-body body-background table-responsive">
        <table id="example8" class="table table-hover text-nowrap projects">
            <thead>
                <tr>
                    <th>Turno</th>
            ...
            <tbody>
                <?php foreach ($dailyOrdersLocalState4 as $order) : //dd($dailyorders); 
                ?>
...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body body-background table-responsive">
        <table id="example7" class="table table-hover text-nowrap projects">
            <thead>
                <tr>
                    <th>Turno</th>
                    <th style="width: 10px;">Cant</th>
            ...
            <tbody>
                <?php foreach ($dailyOrdersDomicilioState4 as $order) : //dd($dailyorders); 
                ?>
